...
export const RepositoryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTree: async (owner: string, repo: string, sha: string, recursive?: boolean, page?: number, per_page?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @param {string} repo name of the repo
         * @param {number} id id of the release
         * @param {number} attachment_id id of the attachment to delete
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        repoDeleteReleaseAttachment: async (owner: string, repo: string, id: number, attachment_id: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
            ...
            // verify required parameter 'attachment_id' is not null or undefined
            if (attachment_id === null || attachment_id === undefined) {
                throw new RequiredError('attachment_id','Required parameter attachment_id was null or undefined when calling repoDeleteReleaseAttachment.');
            }
            const localVarPath = `/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id}`
                .replace(`{${"owner"}}`, encodeURIComponent(String(owner)))
                .replace(`{${"repo"}}`, encodeURIComponent(String(repo)))
                .replace(`{${"id"}}`, encodeURIComponent(String(id)))
                .replace(`{${"attachment_id"}}`, encodeURIComponent(String(attachment_id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
         ...
         * @param {string} repo name of the repo
         * @param {number} id id of the release
         * @param {number} attachment_id id of the attachment to edit
         * @param {EditAttachmentOptions} [body]
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        repoEditReleaseAttachment: async (owner: string, repo: string, id: number, attachment_id: number, body?: EditAttachmentOptions, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
            ...
            // verify required parameter 'attachment_id' is not null or undefined
            if (attachment_id === null || attachment_id === undefined) {
                throw new RequiredError('attachment_id','Required parameter attachment_id was null or undefined when calling repoEditReleaseAttachment.');
            }
            const localVarPath = `/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id}`
                .replace(`{${"owner"}}`, encodeURIComponent(String(owner)))
                .replace(`{${"repo"}}`, encodeURIComponent(String(repo)))
         ...
         * @param {string} repo name of the repo
         * @param {number} id id of the release
         * @param {number} attachment_id id of the attachment to get
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        repoGetReleaseAttachment: async (owner: string, repo: string, id: number, attachment_id: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
            ...
            // verify required parameter 'attachment_id' is not null or undefined
            if (attachment_id === null || attachment_id === undefined) {
                throw new RequiredError('attachment_id','Required parameter attachment_id was null or undefined when calling repoGetReleaseAttachment.');
            }
            const localVarPath = `/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id}`
                .replace(`{${"owner"}}`, encodeURIComponent(String(owner)))
                .replace(`{${"repo"}}`, encodeURIComponent(String(repo)))
         ...
         * @param {string} owner owner of the repo
         * @param {string} repo name of the repo
         * @param {number} [key_id] the key_id to search for
         ...
         * @throws {RequiredError}
         */
        repoListKeys: async (owner: string, repo: string, key_id?: number, fingerprint?: string, page?: number, limit?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
            ...
            if (key_id !== undefined) {
                localVarQueryParameter['key_id'] = key_id;
            }
         ...
         * @param {string} owner owner of the repo
         * @param {string} repo name of the repo
         * @param {number} [per_page] page size of results, deprecated - use limit
         * @param {number} [page] page number of results to return (1-based)
         * @param {number} [limit] page size of results
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        repoListReleases: async (owner: string, repo: string, per_page?: number, page?: number, limit?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @param {number} [priority_owner_id] repo owner to prioritize in the results
         * @param {number} [team_id] search only for repos that belong to the given team id
         ...
         * @param {boolean} [is_private] show only pubic, private or all repositories (defaults to all)
         ...
         * @throws {RequiredError}
         */
        repoSearch: async (q?: string, topic?: boolean, includeDesc?: boolean, uid?: number, priority_owner_id?: number, team_id?: number, starredBy?: number, _private?: boolean, is_private?: boolean, template?: boolean, archived?: boolean, mode?: string, exclusive?: boolean, sort?: string, order?: string, page?: number, limit?: number, options: any = {}): Promise<RequestArgs> => {
            ...
            if (priority_owner_id !== undefined) {
                localVarQueryParameter['priority_owner_id'] = priority_owner_id;
            }
            ...
            if (is_private !== undefined) {
                localVarQueryParameter['is_private'] = is_private;
            }
...
export const RepositoryApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getTree(owner: string, repo: string, sha: string, recursive?: boolean, page?: number, per_page?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GitTreeResponse>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).getTree(owner, repo, sha, recursive, page, per_page, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async repoDeleteReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).repoDeleteReleaseAttachment(owner, repo, id, attachment_id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async repoEditReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, body?: EditAttachmentOptions, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Attachment>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).repoEditReleaseAttachment(owner, repo, id, attachment_id, body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async repoGetReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Attachment>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).repoGetReleaseAttachment(owner, repo, id, attachment_id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async repoListKeys(owner: string, repo: string, key_id?: number, fingerprint?: string, page?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DeployKey>>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).repoListKeys(owner, repo, key_id, fingerprint, page, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async repoListReleases(owner: string, repo: string, per_page?: number, page?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Release>>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).repoListReleases(owner, repo, per_page, page, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async repoSearch(q?: string, topic?: boolean, includeDesc?: boolean, uid?: number, priority_owner_id?: number, team_id?: number, starredBy?: number, _private?: boolean, is_private?: boolean, template?: boolean, archived?: boolean, mode?: string, exclusive?: boolean, sort?: string, order?: string, page?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SearchResults>> {
            const localVarAxiosArgs = await RepositoryApiAxiosParamCreator(configuration).repoSearch(q, topic, includeDesc, uid, priority_owner_id, team_id, starredBy, _private, is_private, template, archived, mode, exclusive, sort, order, page, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RepositoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTree(owner: string, repo: string, sha: string, recursive?: boolean, page?: number, per_page?: number, options?: any): AxiosPromise<GitTreeResponse> {
            return RepositoryApiFp(configuration).getTree(owner, repo, sha, recursive, page, per_page, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary List a repository's forks
         ...
         * @throws {RequiredError}
         */
        repoDeleteReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, options?: any): AxiosPromise<void> {
            return RepositoryApiFp(configuration).repoDeleteReleaseAttachment(owner, repo, id, attachment_id, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Delete a release by tag name
         ...
         * @throws {RequiredError}
         */
        repoEditReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, body?: EditAttachmentOptions, options?: any): AxiosPromise<Attachment> {
            return RepositoryApiFp(configuration).repoEditReleaseAttachment(owner, repo, id, attachment_id, body, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Get a repository
         ...
         * @throws {RequiredError}
         */
        repoGetReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, options?: any): AxiosPromise<Attachment> {
            return RepositoryApiFp(configuration).repoGetReleaseAttachment(owner, repo, id, attachment_id, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Get a release by tag name
         ...
         * @throws {RequiredError}
         */
        repoListKeys(owner: string, repo: string, key_id?: number, fingerprint?: string, page?: number, limit?: number, options?: any): AxiosPromise<Array<DeployKey>> {
            return RepositoryApiFp(configuration).repoListKeys(owner, repo, key_id, fingerprint, page, limit, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary List a repo's pull requests
         ...
         * @throws {RequiredError}
         */
        repoListReleases(owner: string, repo: string, per_page?: number, page?: number, limit?: number, options?: any): AxiosPromise<Array<Release>> {
            return RepositoryApiFp(configuration).repoListReleases(owner, repo, per_page, page, limit, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary List a repo's stargazers
         ...
         * @throws {RequiredError}
         */
        repoSearch(q?: string, topic?: boolean, includeDesc?: boolean, uid?: number, priority_owner_id?: number, team_id?: number, starredBy?: number, _private?: boolean, is_private?: boolean, template?: boolean, archived?: boolean, mode?: string, exclusive?: boolean, sort?: string, order?: string, page?: number, limit?: number, options?: any): AxiosPromise<SearchResults> {
            return RepositoryApiFp(configuration).repoSearch(q, topic, includeDesc, uid, priority_owner_id, team_id, starredBy, _private, is_private, template, archived, mode, exclusive, sort, order, page, limit, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Get signing-key.gpg for given repository
...
export class RepositoryApi extends BaseAPI {
     ...
     * @memberof RepositoryApi
     */
    public getTree(owner: string, repo: string, sha: string, recursive?: boolean, page?: number, per_page?: number, options?: any) {
        return RepositoryApiFp(this.configuration).getTree(owner, repo, sha, recursive, page, per_page, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary List a repository's forks
     ...
     * @memberof RepositoryApi
     */
    public repoDeleteReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, options?: any) {
        return RepositoryApiFp(this.configuration).repoDeleteReleaseAttachment(owner, repo, id, attachment_id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Delete a release by tag name
     ...
     * @memberof RepositoryApi
     */
    public repoEditReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, body?: EditAttachmentOptions, options?: any) {
        return RepositoryApiFp(this.configuration).repoEditReleaseAttachment(owner, repo, id, attachment_id, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get a repository
     ...
     * @memberof RepositoryApi
     */
    public repoGetReleaseAttachment(owner: string, repo: string, id: number, attachment_id: number, options?: any) {
        return RepositoryApiFp(this.configuration).repoGetReleaseAttachment(owner, repo, id, attachment_id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get a release by tag name
     ...
     * @memberof RepositoryApi
     */
    public repoListKeys(owner: string, repo: string, key_id?: number, fingerprint?: string, page?: number, limit?: number, options?: any) {
        return RepositoryApiFp(this.configuration).repoListKeys(owner, repo, key_id, fingerprint, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary List a repo's pull requests
     ...
     * @memberof RepositoryApi
     */
    public repoListReleases(owner: string, repo: string, per_page?: number, page?: number, limit?: number, options?: any) {
        return RepositoryApiFp(this.configuration).repoListReleases(owner, repo, per_page, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary List a repo's stargazers
     ...
     * @memberof RepositoryApi
     */
    public repoSearch(q?: string, topic?: boolean, includeDesc?: boolean, uid?: number, priority_owner_id?: number, team_id?: number, starredBy?: number, _private?: boolean, is_private?: boolean, template?: boolean, archived?: boolean, mode?: string, exclusive?: boolean, sort?: string, order?: string, page?: number, limit?: number, options?: any) {
        return RepositoryApiFp(this.configuration).repoSearch(q, topic, includeDesc, uid, priority_owner_id, team_id, starredBy, _private, is_private, template, archived, mode, exclusive, sort, order, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get signing-key.gpg for given repository
